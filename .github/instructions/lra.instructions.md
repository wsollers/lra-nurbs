...
Canonical overlay: docs/governance/repo-overlays/lra-nurbs.md
...
Canonical repo overlay: `docs/governance/repo-overlays/lra-nurbs.md`
Canonical route resolver:
`python <governance-root>/capabilities/resolve.py --repo lra-nurbs --task "<user task>" --root <repo-root>`
