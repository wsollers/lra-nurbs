...
Canonical overlay: capabilities/overlays/lra-nurbs.md
...
Repository: `lra-nurbs`
Canonical repo overlay: `capabilities/overlays/lra-nurbs.md`
Canonical route resolver:
`python <governance-root>/scripts/govpy.py capabilities/resolve.py --repo lra-nurbs --task "<user task>" --root <repo-root>`
